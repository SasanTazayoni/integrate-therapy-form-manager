...
const BECKS_ITEMS: Item[] = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: 2,
        text: "I am very worried about physical problems and it's hard to think about anything else.",
      },
      {
        value: 3,
        text: "I am so worried about my physical problems that I cannot think about anything else.",
      },
    ],
  },
  {
    ...
    options: [
      {
        value: 0,
        text: "I have not noticed any change in my interest in sex.",
      },
