...
const YSQEmotionalDeprivation: Item[] = [
  {
    id: 1,
    prompt: "People have not been there to meet my emotional needs",
    options: OPTIONS,
    category: "ED",
  },
  {
    id: 2,
    prompt: "I haven’t gotten enough love and attention",
    options: OPTIONS,
    category: "ED",
  },
  {
  ...
  {
    id: 7,
    prompt: "For much of my life, I haven’t felt that I am special to someone",
    options: OPTIONS,
    category: "ED",
  },
  {
...
export default YSQEmotionalDeprivation;
