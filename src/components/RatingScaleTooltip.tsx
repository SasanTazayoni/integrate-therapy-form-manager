...
const RatingScaleTooltip = ({ title, items }: RatingScaleTooltipProps) => {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed top-9 sm:top-14 right-2 sm:right-4 z-50 w-48 sm:w-64 p-2 sm:p-4 bg-white border-2 border-gray-400 rounded-lg shadow-lg text-xs sm:text-sm">
